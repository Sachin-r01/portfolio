          ...
          <div className="flex flex-col md:flex-row gap-8">
            <div className="md:w-1/3">
              ...
              <div className="text-center">
                <h3 className="font-bold text-lg text-gray-800 dark:text-white">Sachin R</h3>
            ...
            <div className="md:w-2/3">
              ...
              I'm a passionate Full Stack Developer specializing in the MERN stack, with strong expertise in building scalable web applications using MongoDB, Express.js, React, and Node.js. My journey in web development began 2 years ago, and I've been crafting engaging digital experiences ever since.
              </p>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                  "2+ Years of Full Stack Development Journey<br />
                  Skilled in both frontend and backend technologies, including React, Node.js, MongoDB, and Express."
                  </p>
                </div>
              </div>
